...
public class Population {
    ...
    public List<Integer> Crossing(List<Integer> list, List<Integer> list2) throws ConcurrentModificationException {
        ...
        if (list2.contains(top_left) && (list2.contains(top_right))) {
            ...
            List<Integer> list_ = new ArrayList<Integer>(list);
            List<Integer> list__ = new ArrayList<Integer>(list);
            List<Integer> list2_ = new ArrayList<Integer>(list2);
            ...
            List<Integer> list2_second = new ArrayList<Integer>(list2);
            List<Integer> list2_second_ = new ArrayList<Integer>(list2);
            List<Integer> list_second = new ArrayList<Integer>(list);
            List<Integer> child21 = list2_second.subList(0, gap2_left_);
            List<Integer> child22 = list_second.subList(gap_left, gap_right);
